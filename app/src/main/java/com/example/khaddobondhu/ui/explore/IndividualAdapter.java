...
public class IndividualAdapter extends RecyclerView.Adapter<IndividualAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Set role badge
        holder.userRoleBadgeView.setUserType(individual.getUserType());
        ...
        if (individual.getProfilePictureUrl() != null && !individual.getProfilePictureUrl().isEmpty()) {
            String imageUrl = individual.getProfilePictureUrl();
            Glide.with(context)
                    .load(imageUrl)
            ...
            holder.userImageView.setOnClickListener(v -> {
                ...
                intent.putExtra("image_title", individual.getName() + "'s Profile Picture");
