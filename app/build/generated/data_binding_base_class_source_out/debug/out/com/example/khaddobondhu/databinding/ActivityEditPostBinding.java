...
public final class ActivityEditPostBinding implements ViewBinding {
  ...
  private ActivityEditPostBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull AutoCompleteTextView quantityUnitSpinner, @NonNull Button saveButton,
      @NonNull TextInputEditText titleInput, @NonNull Toolbar toolbar) {
  ...
  public static ActivityEditPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditPostBinding((LinearLayout) rootView, changeImageButton,
          descriptionInput, expiryDateEditText, foodTypeSpinner, locationInput, postImageView,
          postTypeSpinner, priceInput, progressBar, quantityInput, quantityUnitSpinner, saveButton,
          titleInput, toolbar);
    }
